...
import { renderToString } from 'file:///home/ipopo/Downloads/themeforest-mPC5Dk6t-webfolio-creative-portfolio-digital-agency-nuxtjs-template/Main_Files/webfolio-nuxtjs/node_modules/vue/server-renderer/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/ipopo/Downloads/themeforest-mPC5Dk6t-webfolio-creative-portfolio-digital-agency-nuxtjs-template/Main_Files/webfolio-nuxtjs/node_modules/ufo/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/ipopo/Downloads/themeforest-mPC5Dk6t-webfolio-creative-portfolio-digital-agency-nuxtjs-template/Main_Files/webfolio-nuxtjs/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_tnmZ0T = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_tnmZ0T, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///home/ipopo/Downloads/themeforest-mPC5Dk6t-webfolio-creative-portfolio-digital-agency-nuxtjs-template/Main_Files/webfolio-nuxtjs/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/ipopo/Downloads/themeforest-mPC5Dk6t-webfolio-creative-portfolio-digital-agency-nuxtjs-template/Main_Files/webfolio-nuxtjs/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
